...
implements ClassGenerator
{
    ...
    protected static class ClassLoaderData {
        ...
        // Function模拟 getKey 函数：返回 AbstractClassGenerator 的 key
        ...
        public ClassLoaderData(ClassLoader classLoader) {
            ...
            // 使用Function接口模拟函数式编程，避免为每一个方法声明一个类
            Function<AbstractClassGenerator, Object> load =
                    new Function<AbstractClassGenerator, Object>() {
                        public Object apply(AbstractClassGenerator gen) {
                            // 使用传入的AbstractClassGenerator创建代理类
    ...
    protected Object create(Object key) {
        try {
            ...
            // 获取缓存的ClassLoaderData或创建新的ClassLoaderData
        ...
        try {
            ...
            synchronized (classLoader) {
                ...
                String name = generateClassName(
                    data.getUniqueNamePredicate() // 用于类名是否已经使用过的 Predicat
                );
                // 保存类名
